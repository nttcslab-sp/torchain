...
// struct RandReader {
//     using BaseReader = kaldi::nnet3::RandomAccessNnetChainSeqReader;
//     BaseReader _reader;

//     explicit RandReader(const char* rspec) : _reader(BaseReader(rspec)) {

//     }

//     /// use sequence reader interface
// };

// extern "C" {
//     void* my_lib_example_rand_reader_new(const char* examples_rspecifier) {
//         auto example_reader = new RandReader(examples_rspecifier);
